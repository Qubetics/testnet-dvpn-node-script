...
# Qubetics tesnet dVPN Node management script
...
BINARY_URL="https://github.com/Qubetics/testnet-dvpn-node-script/releases/download/ubuntu${UBUNTU_VERSION}/${BINARY}"
echo $BINARY_URL
